...
void lugarOcupado(int trigger, int echo, int led)
{
...
void loop()
{
  ...
  abrirBarrera();
  lugarOcupado(TRIGGER_SENSOR_ESTACION1, ECHO_SENSOR_ESTACION1, LED_HAY_AUTO_ESTACION1);
  lugarOcupado(TRIGGER_SENSOR_ESTACION2, ECHO_SENSOR_ESTACION2, LED_HAY_AUTO_ESTACION2);
  encenderLuzNoche();
